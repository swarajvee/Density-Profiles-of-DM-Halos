...
def rad_density_function(radius, particle_mass, b, fraction,z, part_numb):
    ...
    for i in range(len(radius)):
        ...
        binedge+=bin_edge
        #print(bin_edge)
    edge = binedge/len(radius) #found the problem, upon averaging all the bin edges are same 
    ...
    return mass_pt, rad_density_comoving
...
mass_pt, rad_density_comoving= rad_density_function(rad, particle_mass, b, fraction,z,particle_number)
