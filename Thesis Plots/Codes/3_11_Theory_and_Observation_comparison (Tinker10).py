...
def halo_mass_function(z,Mmin,Mmax):
    mf= MassFunction(hmf_model='Tinker10',z=z, cosmo_model = Planck18, cosmo_params= {'Om0': 0.315192, 'Ob0': 0.02237/h**2, 'Tcmb0':2.7255, 'Neff': 3.04, 'H0': 67.36},sigma_8= 0.807952, n= 0.9649, mdef_model=mass_definitions.SOVirial, Mmin=np.log10(Mmin),Mmax=np.log10(Mmax))
    #plt.loglog()
...
plt.xlim(Mmin,Mmax)
plt.title(f'Halo Mass Function Comparison in Redshifts {z} Using Tinker10 Model')
