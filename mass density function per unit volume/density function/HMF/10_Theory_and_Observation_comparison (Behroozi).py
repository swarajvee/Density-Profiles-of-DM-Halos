...
#for analytic method
file_path = f'/Volumes/Backpack L2/s10 MSc Major Project/Hubble data/csv data/z{z}.csv'
l = 500 # box size
b= 10 #no of bins
...
plt.xlim(Mmin,Mmax)
plt.title(f'Halo Mass Function Comparison in Redshifts {z} Using Behroozi Model')
