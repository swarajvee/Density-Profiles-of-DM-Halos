...
#from colossus
def MassFunc(z,M,l,Om0,Ob0,H0,sigma8,ns,Tcmb0,Neff,Ode0):
    params={'flat':False,'Om0':Om0, 'Ob0':Ob0, 'H0':H0, 'sigma8':sigma8, 'ns':ns, 'relspecies':True, 'Tcmb0':Tcmb0, 'Neff': Neff, 'Ode0':Ode0}
...
MassFunc(z,M,l,Om0,Ob0,H0,sigma8,ns,Tcmb0,Neff,Ode0)
